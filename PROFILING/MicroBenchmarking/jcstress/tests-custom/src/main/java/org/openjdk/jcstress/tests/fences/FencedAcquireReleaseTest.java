...
@Outcome(id = "[1, 0]", expect = Expect.ACCEPTABLE_INTERESTING,  desc = "Can read the default or old value for $x after $y is observed.")
@Outcome(id = "[1, 1]", expect = Expect.ACCEPTABLE_INTERESTING,  desc = "Can read the default or old value for $x after $y is observed.")
