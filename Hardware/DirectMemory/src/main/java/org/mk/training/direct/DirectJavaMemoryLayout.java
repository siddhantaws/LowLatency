 ...
 */
package org.mk.training.direct;
...
public class DirectJavaMemoryLayout
{
    ...
    public static void init()
    {
        ...
        //System.out.println("NUM_RECORDS:"+NUM_RECORDS+" DirectMemoryTrade.getObjectSize():"+DirectMemoryTrade.getObjectSize());
    ...
    private static int pack(final byte[] value)
    {
        ...
        {
            case 4:
                //System.out.println("case 4:"+value[3]);
                  result |= (value[3]);
            case 3:
                //System.out.println("case 3:"+value[2]+" (int)value[2] << 8:)"+((int)value[2] << 8));
                result |= ((int)value[2] << 8);
            case 2:
                //System.out.println("case 2:"+value[1]+" (int)value[1] << 16):"+((int)value[1] << 16));
                result |= ((int)value[1] << 16);
            case 1:
                //System.out.println("case 1:"+value[0]+" (int)value[0] << 24):"+((int)value[0] << 24));
