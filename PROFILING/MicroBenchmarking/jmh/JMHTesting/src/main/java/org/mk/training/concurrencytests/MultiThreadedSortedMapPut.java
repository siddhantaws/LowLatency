...
public class MultiThreadedSortedMapPut {

    private Map<Integer, Integer> map;

    @Param({/*"treemap",*/"synctreemap", "cslm"})
    private String type;
    ...
    public void setup() {
        ...
        //} else 
        if (type.equals("synctreemap")) {
            map = Collections.synchronizedMap(new TreeMap<Integer, Integer>());
        } else if (type.equals("cslm")) {
