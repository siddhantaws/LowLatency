...
public class ParallelArrayMain {
    ...
    static Ops.Predicate concdomain = new Ops.Predicate<Sample.Employee>() {
        @Override
        public boolean op(Employee a) {
            return "Concurrency".equals(a.getDomain());
        }
    };
    static Ops.ObjectToLong experience =new Ops.ObjectToLong<Sample.Employee>() {
        @Override
        public long op(Employee a) {
